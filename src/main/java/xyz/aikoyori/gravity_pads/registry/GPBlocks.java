...
public class GPBlocks implements BlockRegistryContainer {
	public static final DirectionalGravityBlock DIRECTIONAL_GRAVITY_BLOCK = new DirectionalGravityBlock(QuiltBlockSettings.create().sounds(BlockSoundGroup.ANCIENT_DEBRIS).hardness(1.0f).nonOpaque());
	@Override
